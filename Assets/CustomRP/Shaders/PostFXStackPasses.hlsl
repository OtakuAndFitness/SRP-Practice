...
float3 ColorGradingShadowsMidtonesHighlights(float3 color, bool useACES)
{
    ...
    float hightlightsWeight = smoothstep(_SMHRange.z, _SMHRange.w, luminance);
    float midtonesWeight = 1.0 - shadowsWeight - hightlightsWeight;
    return color * _SMHShadows.rgb * shadowsWeight + color * _SMHMidtones.rgb * midtonesWeight + color * _SMHHighlights.rgb * hightlightsWeight;
}
